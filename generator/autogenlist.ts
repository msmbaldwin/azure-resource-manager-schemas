...
const csharpGeneratorProviders: CsharpGeneratorConfig[] = [
    { namespace: 'Dell.Storage', enabled: true },
    { namespace: 'Dynatrace.Observability', enabled: true },
    { namespace: 'GitHub.Network', enabled: true },
    { namespace: 'Microsoft.AAD', enabled: true },
    { namespace: 'Microsoft.Aadiam', enabled: true },
    { namespace: 'Microsoft.Addons', enabled: true },
    { namespace: 'Microsoft.ADHybridHealthService', enabled: true },
    ...
    { namespace: 'Microsoft.App', enabled: true },
    { namespace: 'Microsoft.AppConfiguration', enabled: true },
    { namespace: 'Microsoft.AppPlatform', enabled: true },
    { namespace: 'Microsoft.Attestation', enabled: true },
    { namespace: 'Microsoft.Authorization', enabled: true },
    { namespace: 'Microsoft.Automanage', enabled: true },
    { namespace: 'Microsoft.Automation', enabled: false },
    { namespace: 'Microsoft.AutonomousDevelopmentPlatform', enabled: true },
    { namespace: 'Microsoft.AVS', enabled: true },
    { namespace: 'Microsoft.AwsConnector', enabled: true },
    { namespace: 'Microsoft.AzureActiveDirectory', enabled: true },
    { namespace: 'Microsoft.AzureArcData', enabled: true },
    { namespace: 'Microsoft.AzureData', enabled: true },
    { namespace: 'Microsoft.AzureStack', enabled: true },
    { namespace: 'Microsoft.AzureStackHCI', enabled: true },
    { namespace: 'Microsoft.Batch', enabled: true },
    { namespace: 'Microsoft.Billing', enabled: true },
    { namespace: 'Microsoft.Blockchain', enabled: true },
    { namespace: 'Microsoft.Blueprint', enabled: true },
    { namespace: 'Microsoft.BotService', enabled: true },
    { namespace: 'Microsoft.Cache', enabled: true },
    { namespace: 'Microsoft.Capacity', enabled: true },
    { namespace: 'Microsoft.Cdn', enabled: true },
    { namespace: 'Microsoft.CertificateRegistration', enabled: true },
    { namespace: 'Microsoft.ChangeAnalysis', enabled: true },
    { namespace: 'Microsoft.Chaos', enabled: true },
    { namespace: 'Microsoft.CodeSigning', enabled: true },
    { namespace: 'Microsoft.CognitiveServices', enabled: false },
    { namespace: 'Microsoft.Commerce', enabled: true },
    { namespace: 'Microsoft.Communication', enabled: true },
    { namespace: 'Microsoft.Compute', enabled: false },
    { namespace: 'Microsoft.Confluent', enabled: true },
    { namespace: 'Microsoft.ConnectedCache', enabled: true },
    { namespace: 'Microsoft.ConnectedVMwarevSphere', enabled: true },
    { namespace: 'Microsoft.Consumption', enabled: true },
    { namespace: 'Microsoft.ContainerInstance', enabled: true },
    { namespace: 'Microsoft.ContainerRegistry', enabled: false },
    { namespace: 'Microsoft.ContainerService', enabled: false },
    { namespace: 'Microsoft.CostManagement', enabled: true },
    { namespace: 'Microsoft.CustomerLockbox', enabled: true },
    { namespace: 'Microsoft.CustomProviders', enabled: true },
    { namespace: 'Microsoft.Dashboard', enabled: true },
    { namespace: 'Microsoft.DataBox', enabled: true },
    { namespace: 'Microsoft.DataBoxEdge', enabled: true },
    { namespace: 'Microsoft.Databricks', enabled: true },
    { namespace: 'Microsoft.DataCatalog', enabled: true },
    { namespace: 'Microsoft.Datadog', enabled: true },
    { namespace: 'Microsoft.DataFactory', enabled: false },
    { namespace: 'Microsoft.DataLakeAnalytics', enabled: true },
    { namespace: 'Microsoft.DataLakeStore', enabled: true },
    { namespace: 'Microsoft.DataMigration', enabled: true },
    { namespace: 'Microsoft.DataProtection', enabled: true },
    { namespace: 'Microsoft.DataReplication', enabled: true },
    { namespace: 'Microsoft.DataShare', enabled: true },
    ...
    { namespace: 'Microsoft.DependencyMap', enabled: true },
    { namespace: 'Microsoft.DesktopVirtualization', enabled: true },
    ...
    { namespace: 'Microsoft.DevOpsInfrastructure', enabled: true },
    { namespace: 'Microsoft.DevSpaces', enabled: true },
    { namespace: 'Microsoft.DevTestLab', enabled: true },
    { namespace: 'Microsoft.DigitalTwins', enabled: true },
    { namespace: 'Microsoft.DocumentDB', enabled: false },
    { namespace: 'Microsoft.DomainRegistration', enabled: true },
    { namespace: 'Microsoft.DurableTask', enabled: true },
    { namespace: 'Microsoft.Easm', enabled: true },
    { namespace: 'Microsoft.EdgeOrderPartner', enabled: true },
    { namespace: 'Microsoft.Elastic', enabled: true },
    { namespace: 'Microsoft.ElasticSan', enabled: true },
    { namespace: 'Microsoft.EngagementFabric', enabled: true },
    { namespace: 'Microsoft.EnterpriseKnowledgeGraph', enabled: true },
    { namespace: 'Microsoft.EventGrid', enabled: false },
    { namespace: 'Microsoft.EventHub', enabled: false },
    { namespace: 'Microsoft.ExtendedLocation', enabled: true },
    { namespace: 'Microsoft.Fabric', enabled: true },
    { namespace: 'Microsoft.Features', enabled: true },
    { namespace: 'Microsoft.GuestConfiguration', enabled: true },
    { namespace: 'Microsoft.HanaOnAzure', enabled: true },
    { namespace: 'Microsoft.HardwareSecurityModules', enabled: true },
    { namespace: 'Microsoft.HDInsight', enabled: true },
    { namespace: 'Microsoft.HealthBot', enabled: true },
    { namespace: 'Microsoft.HealthcareApis', enabled: true },
    { namespace: 'Microsoft.HybridCompute', enabled: true },
    { namespace: 'Microsoft.HybridConnectivity', enabled: true },
    { namespace: 'Microsoft.HybridData', enabled: true },
    { namespace: 'Microsoft.HybridNetwork', enabled: true },
    { namespace: 'Microsoft.ImportExport', enabled: true },
    { namespace: 'Microsoft.Insights', enabled: false },
    { namespace: 'Microsoft.Intune', enabled: true },
    { namespace: 'Microsoft.IotCentral', enabled: true },
    { namespace: 'Microsoft.IoTSecurity', enabled: true },
    { namespace: 'Microsoft.IoTSpaces', enabled: true },
    { namespace: 'Microsoft.KeyVault', enabled: false },
    { namespace: 'Microsoft.Kubernetes', enabled: true },
    { namespace: 'Microsoft.KubernetesConfiguration', enabled: true },
    { namespace: 'Microsoft.Kusto', enabled: true },
    { namespace: 'Microsoft.LabServices', enabled: true },
    { namespace: 'Microsoft.Logic', enabled: false },
    { namespace: 'Microsoft.Logz', enabled: true },
    { namespace: 'Microsoft.MachineLearning', enabled: true },
    { namespace: 'Microsoft.MachineLearningCompute', enabled: true },
    { namespace: 'Microsoft.MachineLearningExperimentation', enabled: true },
    { namespace: 'Microsoft.MachineLearningServices', enabled: true },
    { namespace: 'Microsoft.Maintenance', enabled: true },
    { namespace: 'Microsoft.ManagedNetwork', enabled: true },
    { namespace: 'Microsoft.ManagedServices', enabled: true },
    { namespace: 'Microsoft.Management', enabled: true },
    ...
    { namespace: 'Microsoft.Monitor', enabled: true },
    ...
    { namespace: 'Microsoft.OperationsManagement', enabled: true },
    { namespace: 'Microsoft.Peering', enabled: true },
    { namespace: 'Microsoft.PolicyInsights', enabled: true },
    { namespace: 'Microsoft.Portal', enabled: true },
    { namespace: 'Microsoft.PowerBI', enabled: true },
    { namespace: 'Microsoft.PowerBIDedicated', enabled: true },
    { namespace: 'Microsoft.PowerPlatform', enabled: true },
    { namespace: 'Microsoft.ProviderHub', enabled: true },
    { namespace: 'Microsoft.Purview', enabled: true },
    { namespace: 'Microsoft.Quantum', enabled: true },
    { namespace: 'Microsoft.Quota', enabled: true },
    { namespace: 'Microsoft.RecoveryServices', enabled: false },
    { namespace: 'Microsoft.RedHatOpenShift', enabled: true },
    { namespace: 'Microsoft.Relay', enabled: true },
    { namespace: 'Microsoft.ResourceConnector', enabled: true },
    { namespace: 'Microsoft.ResourceGraph', enabled: true },
    ...
    { namespace: 'Microsoft.ScVmm', enabled: true },
    { namespace: 'Microsoft.Search', enabled: true },
    { namespace: 'Microsoft.Security', enabled: true },
    ...
    { namespace: 'Microsoft.SignalRService', enabled: true },
    { namespace: 'Microsoft.SoftwarePlan', enabled: true },
    { namespace: 'Microsoft.Solutions', enabled: true },
    { namespace: 'Microsoft.Sql', enabled: false },
    { namespace: 'Microsoft.SqlVirtualMachine', enabled: true },
    { namespace: 'Microsoft.Storage', enabled: false },
    { namespace: 'Microsoft.StorageCache', enabled: true },
    { namespace: 'Microsoft.StorageDiscovery', enabled: true },
    { namespace: 'Microsoft.StoragePool', enabled: true },
    { namespace: 'Microsoft.StorageSync', enabled: true },
    { namespace: 'Microsoft.StorSimple', enabled: true },
    { namespace: 'Microsoft.StreamAnalytics', enabled: true },
    { namespace: 'Microsoft.Subscription', enabled: true },
    { namespace: 'Microsoft.Support', enabled: true },
    { namespace: 'Microsoft.Synapse', enabled: true },
    { namespace: 'Microsoft.Syntex', enabled: true },
    { namespace: 'Microsoft.TimeSeriesInsights', enabled: true },
    { namespace: 'Microsoft.VideoIndexer', enabled: true },
    { namespace: 'Microsoft.VirtualMachineImages', enabled: true },
    { namespace: 'Microsoft.VisualStudio', enabled: true },
    { namespace: 'Microsoft.VMwareCloudSimple', enabled: true },
    ...
    { namespace: 'Nginx.NginxPlus', enabled: true },
    { namespace: 'Oracle.Database', enabled: true },
    { namespace: 'Providers.Test', enabled: true },
];
